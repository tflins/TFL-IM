...
import bg from "../assets/img/index_bg.jpg";
import logo from '../assets/img/tfl-im-logo.png'
export default {
  name: "login",
  data() {
    ...
    signUp() {
      ...
      api.signUp(params).then(r => {
        if (r.code === 0) {
          ...
          this.$notify({
            title: "注册成功",
            message: `您的TFL-IM号为：${r.data}，您可以凭此登录，祝您生活愉快！`,
            duration: 5000,
            type: "success"
          });
          this.islogin = true;
