<template>
  <div class="vchat-theme-set">
    <ul class="theme-list">
      <li>
        <div class="theme-style a">浅蓝</div>
        <el-button
          :type="projectTheme === 'vchat' ? 'success' : 'info'"
          :loading="setThemeIng === 'vchat'"
      ...
      <li>
        <div class="theme-style b">优雅</div>
        <el-button
          :type="projectTheme === 'vue' ? 'success' : 'info'"
          :loading="setThemeIng === 'vue'"
          @click="setTheme('vue')"
        >
          <i class="el-icon-success el-icon--right" v-if="projectTheme === 'vue'"></i>
          {{getText('vue')}}
        </el-button>
      </li>
    </ul>
